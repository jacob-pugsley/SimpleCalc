...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Thu Apr 26 12:15:24 2018
# Project:  calc.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -unix -o Makefile calc.pro
#############################################################################
...
Makefile: calc.pro  /usr/lib64/qt4/mkspecs/linux-g++-64/qmake.conf /usr/lib64/qt4/mkspecs/common/g++-multilib.conf \
		/usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/qconfig.pri \
		/usr/lib64/qt4/mkspecs/features/qt_functions.prf \
		...
		/usr/lib64/qt4/mkspecs/features/lex.prf \
		/usr/lib64/qt4/mkspecs/features/include_source_dir.prf
	$(QMAKE) -unix -o Makefile calc.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/calc1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/calc1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/calc1.0.0/ && $(COPY_FILE) --parents calc.ui .tmp/calc1.0.0/ && (cd `dirname .tmp/calc1.0.0` && $(TAR) calc1.0.0.tar calc1.0.0 && $(COMPRESS) calc1.0.0.tar) && $(MOVE) `dirname .tmp/calc1.0.0`/calc1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/calc1.0.0
...
compiler_uic_clean:
	-$(DEL_FILE) ui_calc.h
ui_calc.h: calc.ui
	/usr/lib64/qt4/bin/uic calc.ui -o ui_calc.h
...
main.o: main.cpp ui_calc.h \
		mainwindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

mainwindow.o: mainwindow.cpp ui_calc.h \
		mainwindow.h
